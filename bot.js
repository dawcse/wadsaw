...
client.on('ready', () => { //playing
    client.user.setGame(`ins:qvb7}	`,'https://www.twitch.tv/faresgameryt');
...
❖!زواج لعبة زواج
❖!ابلع  لعبة حلوه
تمت برمجة هذا البوت من قبل جوكر
جميع الحقوق محفوطة
insta : qvb7
...
client.on('message',  message => {
  if(bannedwords.some(word => message.content.includes(word))) {
    message.delete()
    message.reply(" احترم نفسك , يمنع الشتم في السيرفر! او سوف تتعرض الي  ميوت ").then(msg => {msg.delete(5000)});;
  };
});
...
client.login('NTEzNDA0Mjk1MzQxOTMyNTcz.DtHgjQ.631Sdr7MrnaTslRTOSZOsYyFXK4'); 
